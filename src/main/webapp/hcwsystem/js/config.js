var GLOBAL_DEBUG = false;//是否本地调试，true本地调试,false生产环境
...
var GLOBAL_AJAX_URL = {
    ...
    ordinaryPhysicianRegistrationNumber:'/es-med/rest/portfolioEx/generalDocAmount',//普通医师挂号数
    ...
    outpatientConsultation: '/es-med/rest/portfolioEx/outPatientAmount'//门诊总诊量数
};
//模拟的JSON数据
var GLOBAL_JSON = {
    treatmentOutcome: [
    ...
    hospitalizeddepartmentFeesTop10: {
        "average": [
            ["科室一", "34"],
            ["科室二", "30"],
            ["科室三", "21"],
    ...
    hospitalizeddepartmentItemFeesTop10: [
        ["项目一", 543],
        ["项目二", 521],
        ["项目三", 501],
        ["项目四", 498],
