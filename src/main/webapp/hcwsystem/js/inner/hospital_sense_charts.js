        ...
        _ajax({
            ...
            success: function (res) {
                if (res.status) {
                    ...
                    $('#number_01_01').text(parseFloat(res.data.number).toFixed(2));
                    $('#period_01_01').text(parseFloat(res.data.yoy).toFixed(2)+'%');
                    $('#per_year_01_01').text(parseFloat(res.data.qoq).toFixed(2)+'%');
        ...
        _ajax({
            ...
            success: function (res) {
                if (res.status) {
                    ...
                    $('#number_01_02').text(parseFloat(res.data.number).toFixed(2));
