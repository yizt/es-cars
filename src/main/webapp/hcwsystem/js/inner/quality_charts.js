$(function () {
      ...
      success: function (res) {
        if (res.status) {
          ...
          mychart_01_01.setOption({
            color: ['#32ce7a', '#0a4592', '#035aab', '#d9191e', '#ea6320', '#ffae22', '#f564c4', '#503123', '#56969a', '#9b9d04'],
            title: {
              text: year + '年' + month + '月' + day + '日' + department + '治疗结果统计情况',
              left: 'center',
              bottom: '10',
              textStyle: {
                fontWeight: 'normal',
      ...
      success: function (res) {
        if (res.status) {
          ...
          mychart_01_02.setOption({
            color: ['#32ce7a', '#0a4592', '#035aab', '#d9191e', '#ea6320', '#ffae22', '#f564c4', '#503123', '#56969a', '#9b9d04'],
            title: {
              text: year + '年' + month + '月' + department + '治疗结果统计情况',
              left: 'center',
              bottom: '10',
              textStyle: {
                fontWeight: 'normal',
  ...
  function ajax_chart_01_03() {
    ...
    var department = $('#department_01_03').val();
    _ajax({
      url: GLOBAL_AJAX_URL.treatmentOutcome,
      data: JSON.stringify({
        year: year,
      ...
      success: function (res) {
        if (res.status) {
          ...
          mychart_01_03.setOption({
            color: ['#32ce7a', '#0a4592', '#035aab', '#d9191e', '#ea6320', '#ffae22', '#f564c4', '#503123', '#56969a', '#9b9d04'],
            title: {
              text: year + '年' + department + '治疗结果统计情况',
              left: 'center',
              bottom: '10',
              textStyle: {
                fontWeight: 'normal',
