      ...
      success: function (res) {
        if (res.status) {
          ...
          mychart_01_01.setOption({
            color: ['#d9191e'],
            title: {
              text: year + '年' + department + feetype + '出院收入统计',
              left: 'center',
              bottom: '10',
              textStyle: {
                fontWeight: 'normal',
      ...
      success: function (res) {
        if (res.status) {
          ...
          mychart_01_02.setOption({
            color: ['#d9191e'],
            title: {
              text: year + '年' + month + '月' + department + feetype + '出院收入统计',
              left: 'center',
              bottom: '10',
              textStyle: {
                fontWeight: 'normal',
      ...
      success: function (res) {
        if (res.status) {
          ...
          mychart_02_01.setOption({
            color: ['#d9191e'],
            title: {
              text: year + '年' + department + feetype + '门急诊收入统计',
              left: 'center',
              bottom: '10',
              textStyle: {
                fontWeight: 'normal',
      ...
      success: function (res) {
        if (res.status) {
          ...
          mychart_02_02.setOption({
            color: ['#d9191e'],
            title: {
              text: year + '年' + month + '月' + department + feetype + '门急诊收入统计',
              left: 'center',
              bottom: '10',
              textStyle: {
                fontWeight: 'normal',
